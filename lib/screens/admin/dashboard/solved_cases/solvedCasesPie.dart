...
class SolvedIncidentReport extends StatefulWidget {
  @override
  _SolvedIncidentReportState createState() {
    return _SolvedIncidentReportState();
  }
}

class _SolvedIncidentReportState extends State<SolvedIncidentReport> {
  ...
  _generateData(mydata) {
    ...
    _seriesBarData.add(
      charts.Series(
        ...
        id: 'solved',
        data: mydata,
        //labelAccessorFn: (BarGraphModel row, _) => "${row.value}",
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Solved Incident Report'),
      ),
      body: Container(
  ...
  Widget _buildBody(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('solvedIncidentData').snapshots(),
